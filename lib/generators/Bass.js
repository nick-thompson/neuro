...
Bass.prototype._setInternalNodes = function() {
  ...
  this.gainOne = this.ctx.createGain();
  this.gainTwo = this.ctx.createGain();
  this.subGain = this.ctx.createGain();

  this.gainOne.gain.value = 0.30;
  this.gainTwo.gain.value = 0.30;
  this.subGain.gain.value = 0.30;

  this.sawOne.connect(this.gainOne);
  this.sawTwo.connect(this.gainTwo);
  this.sub.connect(this.subGain);

  this.gainOne.connect(this.output);
  this.gainTwo.connect(this.output);
